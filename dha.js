...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "Mrs.Queen","listType": "SINGLE_SELECT","sections": list}}, {})
...
*Feature requests?* Type ${prefix}owners Yes!
 *Rent bots?* Chat wa.me/94782390183`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'Mrs.Queen', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
        ...
        case 'command':
               ...
               listmenuu = [`Menu Group`,`Wibu Menu`,`Sticker Menu`,`Islam Menu`,`Serti Menu`,`Cerita Menu`,`Maker Menu`,`18 + Menu`,`Owner Menu`,`Game Menu`,`Fun Menu`,`Downloader`,`Info Menu`,`MenuLainnya`,`Tools Menu`]
               nombor = 1
               startnum = 0
               ...
               listmsg(from, `${ucapanWaktu}`,  `*Hello User* ${pushname}\nPlease Select Here✌©MRS.QUEEN!`, list)
               break
       case 'othercmd':
               list = []
               listmenu = [`ruleswave`]
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'Mrs.Queen' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `Mrs.Queen`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
*Link Grup :* https://chat.whatsapp.com/G4QllkMjaJoFzgpvuyBtA4
...
"caption": "https://chat.whatsapp.com/G4QllkMjaJoFzgpvuyBtA4",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
"orderTitle": "LOL",
"message":"Hello User",
"sellerJid": "947782390183@s.whatsapp.net",
"token": "AR7i5IXXiMA6NjT0DxcwdcKxhXCy1rOrvlNJzqXPMr8PCg==",
"totalAmount1000": "99999999999999999999",
"totalCurrencyCode": "IDR",
"contextInfo": {
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`*Subcribe YT Owner :*\n https://youtube.com/channel/UCPW2S5FfjiG9XeDdPmcSj2Q`)
              break
       case 'masukandata':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://instagram.com/king_dishuu?utm_medium=copy_link`)
             break
      case 'grupbot':
